...
func _update_visuals() -> void:
	...
	# LOGIQUE D'ANCRAGE Ã€ GAUCHE
	_fg_mesh.scale.x = ratio
	# Calcul du centre pour que le bord gauche reste Ã  -size.x/2
	...
	_label.position.y = 0.05 # LÃ©ger dÃ©collage pour Ã©viter le Z-fighting
	_label.position.z = -0.6 # Au-dessus de la barre sur l'Ã©cran (Top-Down)
...
## DÃ©finit les calques de rendu pour tous les composants visuels (IP-102)
