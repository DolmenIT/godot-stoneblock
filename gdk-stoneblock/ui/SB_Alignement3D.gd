...
@export var parent_anchor: SB_Anchor = SB_Anchor.CENTER:
	set(v): parent_anchor = v; _queue_update()
## Point de référence sur l'écran (Cible).
@export var target_anchor: SB_Anchor = SB_Anchor.TOP_LEFT:
...
func _update_alignment() -> void:
	...
	match target_anchor:
		SB_Anchor.TOP_LEFT:      target_pos = Vector2(-view_w/2,  view_h/2)
		SB_Anchor.TOP_CENTER:    target_pos = Vector2(0,          view_h/2)
		SB_Anchor.TOP_RIGHT:     target_pos = Vector2(view_w/2,   view_h/2)
		SB_Anchor.CENTER_LEFT:   target_pos = Vector2(-view_w/2,  0)
		SB_Anchor.CENTER:        target_pos = Vector2(0,          0)
		SB_Anchor.CENTER_RIGHT:  target_pos = Vector2(view_w/2,   0)
		SB_Anchor.BOTTOM_LEFT:   target_pos = Vector2(-view_w/2, -view_h/2)
		SB_Anchor.BOTTOM_CENTER: target_pos = Vector2(0,         -view_h/2)
		SB_Anchor.BOTTOM_RIGHT:  target_pos = Vector2(view_w/2,  -view_h/2)
	...
	# Fallback manuel si dÃ©tection nulle
	...
	match parent_anchor:
		SB_Anchor.TOP_LEFT:      parent_off = Vector2(-pw/2,  ph/2)
		SB_Anchor.TOP_CENTER:    parent_off = Vector2(0,      ph/2)
		SB_Anchor.TOP_RIGHT:     parent_off = Vector2(pw/2,   ph/2)
		SB_Anchor.CENTER_LEFT:   parent_off = Vector2(-pw/2,  0)
		SB_Anchor.CENTER:        parent_off = Vector2(0,      0)
		SB_Anchor.CENTER_RIGHT:  parent_off = Vector2(pw/2,   0)
		SB_Anchor.BOTTOM_LEFT:   parent_off = Vector2(-pw/2, -ph/2)
		SB_Anchor.BOTTOM_CENTER: parent_off = Vector2(0,     -ph/2)
		SB_Anchor.BOTTOM_RIGHT:  parent_off = Vector2(pw/2,  -ph/2)
	...
	# Appliquer (On prÃ©serve le Z du parent)
