...
## Un composant de dÃ©gradÃ© simplifiÃ© pour le SDK StoneBlock.
## Permet de crÃ©er rapidement des dÃ©gradÃ©s verticaux, horizontaux ou diagonaux.
...
## Cliquez pour forcer le dÃ©gradÃ© Ã  remplir tout l'espace de son parent.
@export var fill_parent: bool = false:
	set(value):
		if value:
			set_anchors_and_offsets_preset(Control.PRESET_FULL_RECT)
		fill_parent = false # Reset aprÃ¨s action

func _init() -> void:
	# Configuration par dÃ©faut pour que Ã§a remplisse l'espace
