...
## RÃ©sout les cibles dynamiquement par NOM dans la scÃ¨ne.
...
# Cache pour Ã©viter de chercher dans l'arbre Ã  chaque frame
var _node_cache: Dictionary = {}
# Cache des Ã©tats pour Ã©viter de spammer les appels si la valeur ne change pas
...
func _get_target_node(node_name: String) -> Node:
	...
	# VÃ©rifier le cache (si le nÅ“ud est toujours valide)
