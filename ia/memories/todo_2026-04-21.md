...
- [x] **Signal `destroyed`** : Ajout d'un signal puissant et standard dans `SB_Enemy_VShmup.gd` pour la communication Parent/Enfant. ✅
...
- [x] **HUD Superposé** : Refonte de `hud.tscn` and `HUD_VShmup.gd` pour afficher le bouclier (Cyan) par dessus la vie (Rouge/Vert). ✅
