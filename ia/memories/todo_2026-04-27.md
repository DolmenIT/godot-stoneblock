...
- [x] **Cases à cocher Background/Mainground** : Ajout de `load_background` and `load_mainground` dans `SB_GameMode_VShmup.gd`. ✅
...
- [x] **Stoppage Rendu Viewports** : `render_target_update_mode = UPDATE_DISABLED` for the SubViewports of bloom sur mobile. ✅
...
- [x] **Protocole IA** : Ajout de la commande `!ia.md` for the rafraîchissement global des règles. ✅
