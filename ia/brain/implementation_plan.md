...
- **[IP-142] [Scission des Conteneurs (Static vs Dynamic)](./implementation_plans/IP-142_Container_Splitting.md)** : Optimisation du FlexContainer pour le Level Design. (STATUT: Terminée) ✅
- **[IP-141] [Scission des Ancres (Static vs Dynamic)](./implementation_plans/IP-141_Anchor_Splitting.md)** : Optimisation des performances des ancres 3D. (STATUT: Terminée) ✅
